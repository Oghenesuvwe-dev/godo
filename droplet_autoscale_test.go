...
func TestDropletAutoscaler_Delete(t *testing.T) {
	...
	autoscalePoolID := "d50d8276-ad17-475d-8d2a-26b0acac756c"
	mux.HandleFunc(fmt.Sprintf("%s/%s", dropletAutoscaleBasePath, autoscalePoolID), func(_ http.ResponseWriter, r *http.Request) {
...
func TestDropletAutoscaler_DeleteDangerous(t *testing.T) {
	...
	autoscalePoolID := "d50d8276-ad17-475d-8d2a-26b0acac756c"
	mux.HandleFunc(fmt.Sprintf("%s/%s/dangerous", dropletAutoscaleBasePath, autoscalePoolID), func(_ http.ResponseWriter, r *http.Request) {
		testMethod(t, r, http.MethodDelete)
